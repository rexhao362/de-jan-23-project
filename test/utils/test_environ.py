...
@pytest.fixture
def empty_mock_environ():
    with patch.dict("os.environ", {}, clear=True) as e:
        yield e

### is_production_environ
def test_is_production_environ(empty_mock_environ):
...
### is_dev_environ
def test_is_dev_environ(empty_mock_environ):
...
def test_set_def_environ(empty_mock_environ, test_value):
    # act
...
### unset_dev_environ
def test_unset_def_environ(dev_mock_environ):
    # act
    unset_dev_environ()
    # assert
